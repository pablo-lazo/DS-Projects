...
```
    ...
    <matplotlib.image.AxesImage at 0x7f5a2406f278>
...
def plot_rgb(image_data):
    ...
    for ix, color in enumerate(channels):
        plot_kde(image_data[:, :, ix], channels[ix])
...
# get the shape of the resulting array
honey_bw_arr_shape = np.shape(honey_bw_arr)
...
![png](output_15_2.png)
    ...
    <matplotlib.axes._subplots.AxesSubplot at 0x7f5a19a1c7f0>
...
![png](output_17_0.png)
    ...
    [[100 100 100 ... 100 100 100]
     ...
     [100 100 100 ... 100 100 100]
     ...
     [100 170 241 ... 100 100 100]
     [100 204 249 ... 100 100 100]
     [161 226 233 ... 100 100 100]]
